# StudyClawHub Setup Instructions

> This file is for Claude Code / OpenClaw to read. If you're an agent
> helping a user install StudyClawHub, follow the steps below.

## What to do

Download the hub skills from this repo and install them into the user's project.
...
2. Download each hub skill's SKILL.md directly:
   ```bash
